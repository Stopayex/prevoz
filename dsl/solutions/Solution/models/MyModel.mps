...
<model ref="r:943dcf34-382e-4269-9b9a-8ef37ef3f679(MyModel)">
  ...
  <registry>
    <language id="e5fe35c4-b143-450c-93f1-f1697b004278" name="DSL">
      <concept id="6714484296018352874" name="DSL.structure.Car" flags="ng" index="JcB$e">
        <property id="6714484296018352876" name="car" index="JcB$8" />
      </concept>
      <concept id="6714484296018352805" name="DSL.structure.Notes" flags="ng" index="JcB_1">
        <property id="6714484296018352807" name="notes" index="JcB_3" />
      </concept>
      <concept id="6714484296018352802" name="DSL.structure.PhoneNumber" flags="ng" index="JcB_6">
        <property id="6714484296018352804" name="phoneNumber" index="JcB_0" />
      </concept>
      <concept id="6714484296018352814" name="DSL.structure.AfterTomorrow" flags="ng" index="JcB_a">
        <property id="6714484296018352816" name="afterTomorrow" index="JcB_k" />
      </concept>
      <concept id="6714484296018352808" name="DSL.structure.Today" flags="ng" index="JcB_c">
        <property id="6714484296018352810" name="today" index="JcB_e" />
      </concept>
      <concept id="6714484296018352811" name="DSL.structure.Tomorrow" flags="ng" index="JcB_f">
        <property id="6714484296018352813" name="tomorrow" index="JcB_9" />
      </concept>
      <concept id="6714484296018352820" name="DSL.structure.ButtonAdd" flags="ng" index="JcB_g">
        <property id="6714484296018352822" name="buttonAdd" index="JcB_i" />
      </concept>
      <concept id="6714484296018352823" name="DSL.structure.ButtonSearch" flags="ng" index="JcB_j">
        <property id="6714484296018352825" name="buttonSearch" index="JcB_t" />
      </concept>
      <concept id="6714484296018352817" name="DSL.structure.ButtonEdit" flags="ng" index="JcB_l">
        <property id="6714484296018352819" name="buttonEdit" index="JcB_n" />
      </concept>
      <concept id="6714484296018352782" name="DSL.structure.From" flags="ng" index="JcB_E">
        <property id="6714484296018352785" name="from" index="JcB_P" />
      </concept>
      <concept id="6714484296018352790" name="DSL.structure.Date" flags="ng" index="JcB_M">
        <property id="6714484296018352792" name="date" index="JcB_W" />
      </concept>
      <concept id="6714484296018352787" name="DSL.structure.To" flags="ng" index="JcB_R">
        <property id="6714484296018352789" name="to" index="JcB_L" />
      </concept>
      <concept id="6714484296018352796" name="DSL.structure.Seats" flags="ng" index="JcB_S">
        <property id="6714484296018352798" name="seats" index="JcB_U" />
      </concept>
      <concept id="6714484296018352799" name="DSL.structure.Price" flags="ng" index="JcB_V">
        <property id="6714484296018352801" name="price" index="JcB_5" />
      </concept>
      <concept id="6714484296018352793" name="DSL.structure.Time" flags="ng" index="JcB_X">
        <property id="6714484296018352795" name="time" index="JcB_Z" />
      </concept>
      <concept id="6714484296018352748" name="DSL.structure.TitleRideEdit" flags="ng" index="JcBA8">
        <property id="6714484296018352750" name="titleRideEdit" index="JcBAa" />
      </concept>
      <concept id="6714484296018352751" name="DSL.structure.TitleRideSearch" flags="ng" index="JcBAb">
        <property id="6714484296018352753" name="titleRideSearch" index="JcBAl" />
      </concept>
      <concept id="6714484296018352745" name="DSL.structure.TitleRideAdd" flags="ng" index="JcBAd">
        <property id="6714484296018352747" name="titleRideAdd" index="JcBAf" />
      </concept>
      <concept id="6714484296018352695" name="DSL.structure.RidesDictionary" flags="ng" index="JcBBj">
        <child id="7123760922561404945" name="buttonSearch" index="2OM4V1" />
        <child id="7123760922561404891" name="afterTomorrow" index="2OM74b" />
        <child id="7123760922561404875" name="tomorrow" index="2OM74r" />
        <child id="7123760922561404926" name="buttonAdd" index="2OM74I" />
        <child id="7123760922561404908" name="buttonEdit" index="2OM74W" />
        <child id="7123760922561404821" name="car" index="2OM755" />
        <child id="7123760922561404800" name="seats" index="2OM75g" />
        <child id="7123760922561404810" name="price" index="2OM75q" />
        <child id="7123760922561404860" name="today" index="2OM75G" />
        <child id="7123760922561404833" name="phoneNumber" index="2OM75L" />
        <child id="7123760922561404846" name="notes" index="2OM75Y" />
        <child id="7123760922561404756" name="titleRide" index="2OM764" />
        <child id="7123760922561404758" name="titleRideEdit" index="2OM766" />
        <child id="7123760922561404761" name="titleRideAdd" index="2OM769" />
        <child id="7123760922561404765" name="titleRideSearch" index="2OM76d" />
        <child id="7123760922561404791" name="time" index="2OM76B" />
        <child id="7123760922561404770" name="from" index="2OM76M" />
        <child id="7123760922561404776" name="to" index="2OM76S" />
        <child id="7123760922561404783" name="date" index="2OM76Z" />
        <child id="9015373308059644472" name="titleRides" index="1_sZxU" />
        <child id="9015373308064409046" name="buttonDelete" index="1_EEYk" />
      </concept>
      ...
      <concept id="7123760922561671134" name="DSL.structure.TitleRegister" flags="ng" index="2OL44e">
        <property id="7123760922561671136" name="titleRegister" index="2OL44K" />
      </concept>
      <concept id="7123760922561671153" name="DSL.structure.ButtonLogOut" flags="ng" index="2OL44x">
        <property id="7123760922561671155" name="buttonLogOut" index="2OL44z" />
      </concept>
      <concept id="7123760922561671156" name="DSL.structure.ButtonLogin" flags="ng" index="2OL44$">
        <property id="7123760922561671158" name="buttonLogin" index="2OL44A" />
      </concept>
      <concept id="7123760922561671137" name="DSL.structure.TitleEdit" flags="ng" index="2OL44L">
        <property id="7123760922561671139" name="titleEdit" index="2OL44N" />
      </concept>
      <concept id="7123760922561671141" name="DSL.structure.Name" flags="ng" index="2OL44P" />
      <concept id="7123760922561671144" name="DSL.structure.Surname" flags="ng" index="2OL44S">
        <property id="7123760922561671146" name="surname" index="2OL44U" />
      </concept>
      <concept id="7123760922561671147" name="DSL.structure.Email" flags="ng" index="2OL44V">
        <property id="7123760922561671149" name="email" index="2OL44X" />
      </concept>
      ...
      <concept id="7123760922561671169" name="DSL.structure.ButtonRegister" flags="ng" index="2OL5Vh">
        <property id="7123760922561671171" name="buttonRegister" index="2OL5Vj" />
      </concept>
      ...
      <concept id="1901514289189851649" name="DSL.structure.UsersDictionary" flags="ng" index="347xGE">
        <child id="1901514289189851687" name="phoneNumber" index="347xGc" />
        <child id="1901514289189851706" name="buttonEdit" index="347xGh" />
        <child id="1901514289189851696" name="comment" index="347xGr" />
        <child id="1901514289189851657" name="titleRegister" index="347xGy" />
        <child id="1901514289189851661" name="titleEdit" index="347xGA" />
        <child id="1901514289189851654" name="titleLogin" index="347xGH" />
        <child id="1901514289189851652" name="titleProfile" index="347xGJ" />
        <child id="1901514289189851672" name="surname" index="347xGN" />
        <child id="1901514289189851679" name="email" index="347xGO" />
        <child id="1901514289189851666" name="name" index="347xGT" />
        <child id="1901514289189851756" name="buttonSave" index="347xH7" />
        <child id="1901514289189851717" name="buttonlogOut" index="347xHI" />
        <child id="1901514289189851742" name="buttonRegister" index="347xHP" />
        <child id="1901514289189851729" name="buttonLogin" index="347xHU" />
        <child id="5576243350810085354" name="password" index="37ioKy" />
        <child id="5576243350810085370" name="confirmPassword" index="37ioKM" />
        <child id="9015373308057477304" name="username" index="1_keFU" />
        <child id="9015373308061421374" name="titleLogout" index="1__KlW" />
      </concept>
      ...
      <concept id="5576243350810085147" name="DSL.structure.Password" flags="ng" index="37ioNj">
        <property id="5576243350810085149" name="password" index="37ioNl" />
      </concept>
      <concept id="5576243350810085150" name="DSL.structure.ConfirmPassword" flags="ng" index="37ioNm">
        <property id="5576243350810085152" name="confirmPassword" index="37ioNC" />
      </concept>
      <concept id="9015373308057477197" name="DSL.structure.Username" flags="ng" index="1_keCf">
        <property id="9015373308057477199" name="username" index="1_keCd" />
      </concept>
      <concept id="9015373308059644469" name="DSL.structure.TitleRides" flags="ng" index="1_sZxR">
        <property id="9015373308059644471" name="titleRides" index="1_sZxP" />
      </concept>
      ...
      <concept id="9015373308061421262" name="DSL.structure.TitleLogout" flags="ng" index="1__Kic">
        <property id="9015373308061421264" name="titleLogout" index="1__Kii" />
      </concept>
      <concept id="9015373308064409043" name="DSL.structure.ButtonDelete" flags="ng" index="1_EEYh">
        <property id="9015373308064409045" name="buttonDelete" index="1_EEYn" />
      </concept>
    </language>

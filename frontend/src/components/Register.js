...
function Register() {
    ...
    return (
        ...
        <div className={"py-10 float-left w-3/5"}>
            ...
            <p className="text-tertiary text-3xl font-bold mb-5 text-left">Registracija</p>
            <Card>
                <form onSubmit={(e) => {
                    e.preventDefault();
                    register();
                    ...
                    <div className="space-y-3">
                        ...
                        <div className="">
                            ...
                            <Button text="Registracija" icon="bi bi-box-arrow-in-right" type="submit" btnClick={register}/>
                        </div>

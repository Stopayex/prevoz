            ...
            <Card>
                <div className="flex flex-row">
                    <div className="flex-col">
                        ...
                        <div className="block text-base text-tertiary text-left font-light"><Link to={"/user/" + ride.user._id} className="flex items-center float-left"><p className="bg-greyish rounded-full w-5 h-5 mx-auto flex justify-center mr-1.5"><img className="w-4 h-4" src={logo} alt="Logo"/></p>{ride.user.username}</Link></div>
                    </div>
